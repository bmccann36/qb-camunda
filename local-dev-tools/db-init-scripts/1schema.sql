...
alter table yard owner to postgres;
...
alter table commodity_status owner to postgres;
...
alter table material_type_status owner to postgres;
...
alter table price_sheet owner to postgres;
...
alter table price_entry owner to postgres;
...
alter table benchmark_history owner to postgres;
...
alter table outbound_ticket owner to postgres;
...
alter table packing_list owner to postgres;
...
alter table finished_good owner to postgres;
...
alter table inbound_ticket owner to postgres;
...
alter table material_status owner to postgres;
...
alter table finished_good_status owner to postgres;
...
alter table packing_list_status owner to postgres;
...
alter table inbound_ticket_status owner to postgres;
...
alter table customer_status owner to postgres;
...
alter table outbound_ticket_status owner to postgres;
...
alter table finished_good_note owner to postgres;
...
alter table inbound_ticket_note owner to postgres;
...
alter table regrade owner to postgres;
...
alter table regrade_to owner to postgres;
...
alter table regrade_from owner to postgres;
